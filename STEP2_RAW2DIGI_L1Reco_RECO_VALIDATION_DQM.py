...
# with command line options: STEP2 --step RAW2DIGI,L1Reco,RECO,VALIDATION:validation_prod,DQM:DQMOfflinePOGMC --conditions auto:upgradePLS1 --datamix NODATAMIXER --customise SLHCUpgradeSimulations/Configuration/postLS1CustomsPreMixing.customisePostLS1 --geometry Extended2015 -n 10 --magField 38T_PostLS1 --eventcontent AODSIM,DQM --datatier AODSIM,DQM --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:REDIGI_DIGI_L1_DIGI2RAW.root')
)
...
#process.RandomNumberGeneratorService.generator.initialSeed = 75588
